<%@ Page Title="" Language="C#" MasterPageFile="~/Kullanici.Master" AutoEventWireup="true" CodeBehind="KategoriDetay.aspx.cs" Inherits="DiziFilmBlogSitesi.KategoriDetay" %>
 ...
 <a href="BlogDetay.Aspx?BlogID=<%# Eval("BlogID") %>"><span></span>Devamını Oku</a>
  ...
  <div class="col-md-4 content-right">
	 ...
	 <div class="archives">
		 ...
		 <li><a href="#">Mayıs 2024</a></li>
		 <li><a href="#">Haziran 2024</a></li>
		 <li><a href="#">Temmuz 2024</a></li>
		 </ul>
	 </div>
